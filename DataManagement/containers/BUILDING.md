...
$ docker buildx build \
  ...
  -t ghcr.io/ccomjhc/wibl:1.2.0-amazonlinux -t ghcr.io/ccomjhc/wibl:1.2.0 -t ghcr.io/ccomjhc/wibl:latest \
  cloud/AWS
```
...
> Note: For now, we tag this image both as `1.2.0-amazonlinux` and 
> `1.2.0`. In the future we may plan to build a version of the that is
